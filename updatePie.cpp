...
UpdatePie::UpdatePie(QObject *parent) : QObject(parent)
{

}
void UpdatePie::park_num()
{
...
void UpdatePie::CheckPie(QString m_Parking_name,int m_reserve,int m_now_count_L)
{
